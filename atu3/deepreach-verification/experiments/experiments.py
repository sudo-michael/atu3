...
class Experiment(ABC):
    ...
    def validate(self, save_path, x_resolution, y_resolution, z_resolution, time_resolution, plot=False):
    ...
    def plot(self, epoch, val_x_resolution, val_y_resolution, val_z_resolution, val_time_resolution):
        self._load_checkpoint(epoch)
        self.validate(None, val_x_resolution, val_y_resolution, val_z_resolution, val_time_resolution, plot=True)
