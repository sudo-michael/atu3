...
car_brt = Air3D(r=car_r, u_mode="max", d_mode="min", we_max=0., wp_max=2.84, ve=1, vp=1)
# car_brt_2 = Air3D(r=car_r, u_mode="max", d_mode="min", we_max=2.00, wp_max=2.84, ve=0.22, vp=0.14)
# car_brt_3 = Air3D(r=car_r, u_mode="max", d_mode="min", we_max=2.00, wp_max=2.84, ve=0.22, vp=0.1)
